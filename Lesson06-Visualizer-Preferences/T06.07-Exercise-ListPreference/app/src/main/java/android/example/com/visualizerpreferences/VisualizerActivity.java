...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setColorFromPreferences(SharedPreferences preferences) {
        mVisualizerView.setColor(preferences.getString(getString(R.string.pref_shape_color_key), getString(R.string.pref_color_red_value)));
    }
    ...
    private void setupSharedPreferences() {
        ...
        setColorFromPreferences(sharedPreferences);
